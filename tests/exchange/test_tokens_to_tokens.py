def test_tokens_to_tokens_swap(t, chain, utils, uni_token, swap_token, uniswap_factory, uni_token_exchange, swap_token_exchange, assert_tx_failed):
    ...
    uni_token_exchange.tokens_to_tokens_swap(swap_token.address, 2*10**18, 1, timeout, startgas=133000, sender=t.k1)
...
def test_tokens_to_tokens_payment(t, chain, utils, uni_token, swap_token, uniswap_factory, uni_token_exchange, swap_token_exchange, assert_tx_failed):
    ...
    # BUYER converts ETH to UNI
    uni_token_exchange.tokens_to_tokens_payment(swap_token.address, t.a3, 2*10**18, 1, timeout, startgas=500000, sender=t.k2)
    # Updated balances of UNI exchange
    assert chain.head_state.get_balance(uni_token_exchange.address) == 4168056018672890963
    assert uni_token.balanceOf(uni_token_exchange.address) == 12*10**18
    # Updated balances of SWAP exchange
...
def test_tokens_to_tokens_exact_swap(t, chain, utils, uni_token, swap_token, uniswap_factory, uni_token_exchange, swap_token_exchange, assert_tx_failed):
    ...
    # BUYER converts ETH to UNI
    uni_token_exchange.tokens_to_tokens_exact_swap(swap_token.address, 2848165371366673513, 3*10**18, timeout, startgas=163000, sender=t.k4)
    # Updated balances of UNI exchange
    assert chain.head_state.get_balance(uni_token_exchange.address) == 4168056018672890963
...
def test_tokens_to_tokens_exact_payment(t, chain, utils, uni_token, swap_token, uniswap_factory, uni_token_exchange, swap_token_exchange, assert_tx_failed):
    ...
    # BUYER converts ETH to UNI
    uni_token_exchange.tokens_to_tokens_exact_payment(swap_token.address, t.a6, 2848165371366673513, 3*10**18, timeout, startgas=500000, sender=t.k5)
    # Updated balances of UNI exchange
    assert chain.head_state.get_balance(uni_token_exchange.address) == 4168056018672890963
    assert uni_token.balanceOf(uni_token_exchange.address) == 12*10**18 + 1
    # Updated balances of SWAP exchange
